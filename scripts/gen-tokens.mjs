...
// declared there also appears in styles/base-case.css (the cascade's source of
...
const css = readFileSync(join(root, 'styles', 'base-case.css'), 'utf8');
...
if (missing.length) {
  console.error(`Tokens in src/tokens.js but not declared in styles/base-case.css:\n  ${missing.join('\n  ')}`);
  process.exit(1);
}
